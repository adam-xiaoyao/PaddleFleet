...
if paddle.is_compiled_with_cuda() and paddle.device.get_device() != "cpu":
    _cuda_cap = paddle.cuda.get_device_capability()
    _is_cuda_cap_10 = _cuda_cap[0] == 10
else:
    _is_cuda_cap_10 = False
